...
```bash
$ ./oqa-search.py --help
usage: oqa-search.py [-h] [--url-dashboard-qam URL_DASHBOARD_QAM]
...
Example usages:
```
$ ./oqa-search.py SUSE:Maintenance:36419:353574 --no-aggregated
OpenQA:
#######
...
``` 
$ ./oqa-search.py SUSE:Maintenance:36413:353665 --aggregated-groups core containers
OpenQA:
#######
Single incidents - Core
